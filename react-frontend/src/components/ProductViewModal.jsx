            ...
            <Dialog open={open} as="div" className="relative z-10 " onClose={close}>
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4">
                        <DialogPanel
                            transition
                            className="relatvie transform overflow-hidden rounded-lg bg-white shadow-xl transition-all md:max-w-[620px] md:min-w-[620px] w-full"
                        >
                            {image && (
                            ...
                            <div className={"px-6 py-4 flex justify-end gap-4"}>
                                <button
                                    ...
                                    type="button"
                                    className={"px-4 py-2 text-sm font-semibold text-white bg-blue-600 text-slate-800 rounded-lg"}>
                                    Close
                                </button>
                            </div>
                        </DialogPanel>
